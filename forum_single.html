...
<html>
<head>
<title>Community a Corporate Multipurpose Flat Bootstrap responsive Website Template | Forum Single:: w3layouts</title>
...
<div class="about_banner">
	<div class="container">
		<h2>Forum</h2>
		<span class="breadcrumbs"><a href="index.html"><i class="fa fa-home home_1"></i></a> / <a href="forum.html" class="home_desc">Forum</a> / <span>Single</span></span>
	</div>
</div>
<div class="about_top">
  <div class="container">
	...
	<div class="col-md-9 column-15">
	   <h6>Forum Single</h6>
	   <p class="m_5">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis repellat."</p>
	   <a href="#" class="add_btn classi_btn" data-toggle="modal" data-target="#applyModal">Add New Thread</a>
	  <div class="forum_single">
	   <div class="forum_box3">
	   	  <div class="col-sm-3">
	   	 	<a href="classified_detail.html"><img src="images/c1.jpg" class="img-responsive" alt=""/></a>
	   	  </div>
	   	  <div class="col-sm-9 forum_box1-right">
 	         <span class="forum_post_date">
 				15.11.2015
 			 </span>	
 			 <h4 class="entry-title_1">
 			   <a href="forum_single-post.html">Neque porro quisquam</a>
 			 </h4>
 	         <div class="clearfix"> </div>
	   	 	 <div class="forum_post_cont">
	   	 	   	<span class="forum_post1">By <a href="#" class="author_1">
	   	 	   		standard</a>
	   	 	   	</span>
	   	 	    <span class="forum_slider_post_category">
	   	 	   	   <span class="category_tag">5 Views</span> 
	   	 	   	   <span class="category_tag">0 Replies</span>
	   	 	   	</span>
	   	 	 </div>
	   ...
	   <div class="forum_box3">
	   	 <div class="col-sm-3">
	   	  ...
	   	  <div class="col-sm-9 forum_box1-right">
 			 ...
 			 <h4 class="entry-title_1">
 			   <a href="forum_single-post.html">There are many variations</a>
 			 </h4>
 	         <div class="clearfix"> </div>
	   	 	 <div class="forum_post_cont">
	   	 	   	<span class="forum_post1">By <a href="#" class="author_1">
	   ...
	   <div class="forum_box3">
	   	  ...
	   	  <div class="col-sm-9 forum_box1-right">
 			 ...
 			 <h4 class="entry-title_1">
 			   <a href="forum_single-post.html">But I must explain to you</a>
 			 </h4>
 	         <div class="clearfix"> </div>
	   	 	 <div class="forum_post_cont">
	   	 	   	<span class="forum_post1">By <a href="#" class="author_1">
	   ...
	   <div class="forum_box3">
	   	  ...
	   	  <div class="col-sm-9 forum_box1-right">
 			 ...
 			 <h4 class="entry-title_1">
 			   <a href="forum_single-post.html">On the other hand, we denounce</a>
 			 </h4>
 	         <div class="clearfix"> </div>
	   	 	 <div class="forum_post_cont">
	   	 	   	<span class="forum_post1">By <a href="#" class="author_1">
	   ...
	   <div class="forum_box3">
	   	  <div class="col-sm-3">
	   	 	<a href="classified_detail.html"><img src="images/c6.jpg" class="img-responsive" alt=""/></a>
	   	  </div>
	   	  <div class="col-sm-9 forum_box1-right">
 	         <span class="forum_post_date">
 				10.12.2015
 			 ...
 			 <h4 class="entry-title_1">
 			   <a href="forum_single-post.html">Temporibus autem quibusdam</a>
 			 </h4>
 	         <div class="clearfix"> </div>
	   	 	 <div class="forum_post_cont">
	   	 	   	<span class="forum_post1">By <a href="#" class="author_1">
	   ...
	   <div class="forum_box3">
	   	  <div class="col-sm-3">
	   	 	<a href="classified_detail.html"><img src="images/c8.jpg" class="img-responsive" alt=""/></a>
	   	  </div>
	   	  <div class="col-sm-9 forum_box1-right">
 	         <span class="forum_post_date">
 				10.12.2015
	   ...
	   <div class="forum_box2">
	   	 <div class="col-sm-3">
	   	  ...
	   	  <div class="col-sm-9 forum_box1-right">
 			 ...
 			 <h4 class="entry-title_1">
 			   <a href="forum_single-post.html">To take a trivial example</a>
 			 </h4>
 	         <div class="clearfix"> </div>
	   	 	 <div class="forum_post_cont">
	   	 	   	<span class="forum_post1">By <a href="#" class="author_1">
