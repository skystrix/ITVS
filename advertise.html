...
<html>
<head>
<title>Community a Corporate Multipurpose Flat Bootstrap responsive Website Template | Advertise :: w3layouts</title>
   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            ...
            <li class="current_page"><a href="advertise.html">Advertising</a></li>
...
<div class="about_banner">
	<div class="container">
		<h2>Advertising</h2>
		<span class="breadcrumbs"><a href="index.html"><i class="fa fa-home home_1"></i></a> / <span>Advertising</span></span>
	</div>
</div>
<div class="about_top">
 <div class="container">
