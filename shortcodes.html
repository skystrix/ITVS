...
<html>
<head>
<title>Community a Corporate Multipurpose Flat Bootstrap responsive Website Template | Shortcodes :: w3layouts</title>
...
<div class="about_banner">
	<div class="container">
		<h2>Shortcodes</h2>
		<span class="breadcrumbs"><a href="index.html"><i class="fa fa-home home_1"></i></a> / <a href="news.html" class="home_desc">News</a> / <span>Shortcodes</span></span>
	</div>
</div>
<div class="about_top">
 <div class="container">
	...
	<div class="col-md-9 column-15">
	   ...
	   <div class="font-title">
	     ...
	     <div class="content-inner_2">
	       <h4 class="m_11">Alerts</h4>
		   <div class="row">
		  	<div class="col-md-6">
			   <div class="alert alert_1" role="alert" style=" color: #ffffff; border-color: #7ba7fe; background-color: #7ba7fe;">
          ...
          <div class="row">
          	<div class="col-md-6">
	          <div class="alert alert_1" role="alert" style=" color: #ffffff; border-color: #a3da36; background-color: #a3da36;">
            ...
            <div class="row">
            	<div class="col-md-6">
	             <div class="alert alert_1" role="alert" style=" color: #ffffff; border-color: #2ecc71; background-color: #2ecc71;">
	      ...
	      <div class="content-inner_2">
	      	<h4 class="m_11">Buttons</h4>
			  <div class="row">
				<div class="col-sm-2 but_s">
		          <div class="btn-wrap">
			        <a href="#" class="btn btn-default effect1" target="_self">
	           ...
	           <div class="col-sm-2 but_s">
	              <div class="btn-wrap">
		            <a href="#" class="btn btn-default effect2" target="_self">
			        <i class="fa fa-star"></i>
			          Button
		           </a>
	              </div>
	          ...
	          <div class="col-sm-2 but_s">
	            <div class="btn-wrap">
		         <a href="#" class="btn btn-default effect3" target="_self">
			     Button
		         </a>
	            </div>
	         </div>
	         <div class="col-sm-2 but_s">
	           <div class="btn-wrap">
		        <a href="#" class="btn btn-default effect4" target="_self">
	        ...
	        <div class="col-sm-2 but_s">
	          <div class="btn-wrap">
		         <a href="#" class="btn btn-default effect5" target="_self">
			       <i class="fa fa-facebook no-margin"></i>
			    </a>
	          </div>
	       </div>
	       <div class="col-sm-2 but_s">
	          <div class="btn-wrap">
		        <a href="#" class="btn btn-default effect6" target="_self">
			      <i class="fa fa-twitter no-margin"></i>
			    </a>
	          </div>
	         </div>
	     </div>
<p>&nbsp;</p>
         <div class="row">
         	<div class="col-sm-2 but_s">
	           <div class="btn-wrap">
		         <a href="#" class="btn btn-default medium effect7 " target="_self">
			     <i class="fa fa-star"></i>
			      Button
		        </a>
	          </div>
	       ...
	       <div class="col-sm-2 but_s">
	          <div class="btn-wrap">
		         <a href="#" class="btn btn-default medium effect8" target="_self">
			     <i class="fa fa-star"></i>
			       Button
		         </a>
	           </div>
	      ...
	      <div class="col-sm-2 but_s">
	        <div class="btn-wrap">
		      <a href="#" class="btn btn-default medium effect9" target="_self">
			    Button
		      </a>
	        </div>
	     </div>
	     <div class="col-sm-2 but_s">
	         <div class="btn-wrap">
				<a href="#" class="btn btn-default medium effect10" target="_self">
					<i class="fa fa-facebook "></i>
					Button
				</a>
	        </div>
	    ...
	    <div class="col-sm-2 but_s">
			<div class="btn-wrap">
				<a href="#" class="btn btn-default medium effect11" target="_self">
					<i class="fa fa-facebook no-margin"></i>
				</a>
			</div>
	    </div>
	    <div class="col-sm-2 but_s">
	       <div class="btn-wrap">
			<a href="#" class="btn btn-default medium effect12" target="_self">
				<i class="fa fa-twitter no-margin"></i>
			</a>
	      </div>
	    </div>
...
<p>&nbsp;</p>
    <div class="row">
	   <div class="col-sm-2 but_s">
	        <div class="btn-wrap">
		      <a href="#" class="btn btn-default large effect13 " target="_self">
			 <i class="fa fa-star"></i>
			   Button
		     </a>
	       </div>
	   ...
	   <div class="col-sm-2 but_s">
	    <div class="btn-wrap">
		  <a href="#" class="btn btn-default large effect14" target="_self">
	 ...
	 <div class="col-sm-2 but_s">
	    <div class="btn-wrap">
		   <a href="#" class="btn btn-default large effect15" target="_self">
			 Button
		  </a>
	   </div>
	</div>
	<div class="col-sm-2 but_s">
	  <div class="btn-wrap">
		<a href="#" class="btn btn-default large effect16" target="_self">
			<i class="fa fa-facebook "></i>
			Button
		</a>
	  </div>
	...
	<div class="col-sm-2 but_s">
	   <div class="btn-wrap">
		<a href="#" class="btn btn-default large effect17" target="_self">
			<i class="fa fa-facebook no-margin"></i>
		</a>
	</div>
   </div>
   <div class="col-sm-2 but_s">
	<div class="btn-wrap">
		<a href="#" class="btn btn-default large effect18" target="_self">
			<i class="fa fa-twitter no-margin"></i>
		</a>
	 </div>
	</div>
...
<p>&nbsp;</p>
     <div class="row">
     	<div class="col-sm-6">
	      <div class="btn-wrap">
		    <a href="#" class="btn btn-default effect19" target="_self">
			<i class="fa fa-star"></i>
			  Button
		    </a>
	      </div>
	   ...
	   <div class="col-sm-6">
	    <div class="btn-wrap">
		  <a href="#" class="btn btn-default effect20" target="_self">
			<i class="fa fa-star"></i>
			Button
		  </a>
	    </div>
...
<p>&nbsp;</p>
     <div class="row">
     	<div class="col-sm-6">
	     <div class="btn-wrap">
			<a href="#" class="btn btn-default medium effect21" target="_self">
	   ...
	   <div class="col-sm-6">
	     <div class="btn-wrap">
		   <a href="#" class="btn btn-default medium effect22" target="_self">
			<i class="fa fa-sign-in"></i>
			Button
		   </a>
	    </div>
...
<p>&nbsp;</p>
    <div class="row">
	 ...
	 <div class="content-inner_1">
			<h4 class="m_11">Progress Bars</h4>
			 <div class="row">
					<div class="col-md-6">
						<div class="progress progress_1">
						  <div class="progress-bar " style="width:85%" role="progressbar" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100">
						  		<div class="progress-bar-value_1">98%</div>
	                ...
	                <div class="col-md-6">
						<div class="progress progress_1">
						  <div class="progress-bar " style="width: 67%" role="progressbar" aria-valuenow="67" aria-valuemin="0" aria-valuemax="100">
						  		<div class="progress-bar-value_2">67%</div>
...
<p>&nbsp;</p>
          <div class="row">
	           ...
	           <div class="progress progress_2">
				  <div class="progress-bar " style="width: 98%" role="progressbar" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100">
				  		<div class="progress-bar-value_3">98%</div>
				  		<i class="fa fa-check"></i>Testing
				  </div>
	           </div>
	          </div>
	          <div class="col-md-6">
	           <div class="progress progress_2">
				  <div class="progress-bar " style="width: 80%" role="progressbar" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100">
				  		<div class="progress-bar-value_4">80%</div>
