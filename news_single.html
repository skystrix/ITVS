...
<html>
<head>
<title>Community a Corporate Multipurpose Flat Bootstrap responsive Website Template | News Single :: w3layouts</title>
...
<div class="about_banner">
	<div class="container">
		<h2>News</h2>
		<span class="breadcrumbs"><a href="index.html"><i class="fa fa-home home_1"></i></a> / <a href="news.html" class="home_desc">News</a> / <span>News_Single</span></span>
	</div>
</div>
<div class="about_top">
 <div class="container">
	<div class="col-md-3 column-1">
	   <div class="list-group">
        <a href="#" class="list-group-item active">News Category</a>
        <a href="about_work.html" class="list-group-item">Cricket</a>
        <a href="about_privacy.html" class="list-group-item">Education</a>
        <a href="about_terms.html" class="list-group-item">Health</a>
        <a href="about_tools.html" class="list-group-item">Entertainment</a>
        <a href="news.html" class="list-group-item">Sport</a>
        <a href="news.html" class="list-group-item">Technology</a>
        <a href="news.html" class="list-group-item">Business</a>
        <a href="news.html" class="list-group-item">Bollywood</a>
        <a href="news.html" class="list-group-item">Marketing</a>
       </div>
	</div>
	<div class="col-md-9 column-15">
	   <h6>Latest News</h6>
	    <img src="images/news_banner.jpg" class="img-responsive" alt=""/>
	    <p class="m_7">The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
	     <ul class="list_3">
			  ...
			  <li>
                  ...
                  <div class="col-lg-10 col-sm-10 col-xs-10 comment-content clearfix">
                     <div class="author author-title">
                        <h5><a href="#">There are many variations of passages of Lorem Ipsum available – Lorem</a></h5>
                        <div class="post-element clearfix">
                            <p title="January 3, 2016 10:46" href="#" class="date">5 January</p>
                        </div>
                     </div>
                     ...
                     <div class="clearfix"> </div>
                     <p class="m_20">[…] At vero eos et accusamus et iusto odio […]</p>
                 </div>
                 <div class="clearfix"> </div>
             </li>
             <li>
